...
export class Config {
    ...
    // only `gpt-3.5-turbo` and `gpt-3.5-turbo-0301`, `gpt-4`, `gpt-4-0314`, `gpt-4-32k`,	`gpt-4-32k-0314`	
    public static readonly OPENAI_CHATGPT_MODEL: string = "gpt-4-0314";

    // the model to use if the script is over 5k characters
    public static readonly OPENAI_CHATGPT_MODEL_OVER_5K_LENGTH: string = "gpt-4-32k-0314";
